...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.cost'
        db.alter_column(u'marketplace_classroom', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Classroom.cost'
        db.alter_column(u'marketplace_classroom', 'cost', self.gf('django.db.models.fields.FloatField')())
