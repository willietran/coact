...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'marketplace_user', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Classroom.screenshot'
        db.add_column(u'marketplace_classroom', 'screenshot',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'marketplace_user', 'image')

        # Deleting field 'Classroom.screenshot'
        db.delete_column(u'marketplace_classroom', 'screenshot')
