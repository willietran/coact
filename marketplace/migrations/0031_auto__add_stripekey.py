...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketplace_stripekey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('api_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stripe_key_user', to=orm['marketplace.User'])),
        ))
        db.send_create_signal(u'marketplace', ['StripeKey'])


    def backwards(self, orm):
        # Deleting model 'StripeKey'
        db.delete_table(u'marketplace_stripekey')
