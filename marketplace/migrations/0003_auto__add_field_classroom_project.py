...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.project'
        db.add_column(u'marketplace_classroom', 'project',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.project'
        db.delete_column(u'marketplace_classroom', 'project')
