...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.api_key'
        db.alter_column(u'marketplace_classroom', 'api_key', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Classroom.api_key'
        db.alter_column(u'marketplace_classroom', 'api_key', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100))
