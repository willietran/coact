...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.reviewer'
        db.alter_column(u'marketplace_review', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.User']))

    def backwards(self, orm):

        # Changing field 'Review.reviewer'
        db.alter_column(u'marketplace_review', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketplace.Classroom']))
