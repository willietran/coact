...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'marketplace_review', 'title')

        # Adding field 'Review.review'
        db.add_column(u'marketplace_review', 'review',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'marketplace_review', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140),
                      keep_default=False)

        # Deleting field 'Review.review'
        db.delete_column(u'marketplace_review', 'review')
