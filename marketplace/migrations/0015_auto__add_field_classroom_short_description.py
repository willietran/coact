...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.short_description'
        db.add_column(u'marketplace_classroom', 'short_description',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.short_description'
        db.delete_column(u'marketplace_classroom', 'short_description')
