...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Classroom.student'
        db.delete_column(u'marketplace_classroom', 'student_id')

        # Adding field 'Classroom.description'
        db.add_column(u'marketplace_classroom', 'description',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Classroom.student'
        db.add_column(u'marketplace_classroom', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='classroom_student', to=orm['marketplace.Learner']),
                      keep_default=False)

        # Deleting field 'Classroom.description'
        db.delete_column(u'marketplace_classroom', 'description')
