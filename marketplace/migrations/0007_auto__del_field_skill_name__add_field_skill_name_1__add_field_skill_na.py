...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'marketplace_skill', 'name')

        # Adding field 'Skill.name_1'
        db.add_column(u'marketplace_skill', 'name_1',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'marketplace_skill', 'name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)

        # Deleting field 'Skill.name_1'
        db.delete_column(u'marketplace_skill', 'name_1')
    ...
    models = {
        ...
        u'marketplace.skill': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_1': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'name_2': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'name_3': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
