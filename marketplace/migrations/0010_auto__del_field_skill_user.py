...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Skill.user'
        db.delete_column(u'marketplace_skill', 'user_id')

        # Adding M2M table for field user on 'Skill'
        m2m_table_name = db.shorten_name(u'marketplace_skill_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('skill', models.ForeignKey(orm[u'marketplace.skill'], null=False)),
            ('user', models.ForeignKey(orm[u'marketplace.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['skill_id', 'user_id'])


    def backwards(self, orm):
        # Adding field 'Skill.user'
        db.add_column(u'marketplace_skill', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_skill', to=orm['marketplace.User']),
                      keep_default=False)

        # Removing M2M table for field user on 'Skill'
        db.delete_table(db.shorten_name(u'marketplace_skill_user'))
    ...
    models = {
        ...
        u'marketplace.skill': {
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_skill'", 'symmetrical': 'False', 'to': u"orm['marketplace.User']"})
        },
        u'marketplace.user': {
