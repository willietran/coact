...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketplace_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('charge_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('classroom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_classroom', to=orm['marketplace.Classroom'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_student', to=orm['marketplace.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'marketplace', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'marketplace_payment')
    ...
    models = {
        ...
        u'marketplace.classroom': {
            ...
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'0000'", 'max_length': '100', 'null': 'True'}),
