...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.project'
        db.alter_column(u'marketplace_classroom', 'project', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Classroom.project'
        db.alter_column(u'marketplace_classroom', 'project', self.gf('django.db.models.fields.CharField')(max_length=30))
