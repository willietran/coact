...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Slot'
        db.create_table(u'marketplace_slot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('calendar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slot_calendar', to=orm['marketplace.Calendar'])),
            ('day', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('time', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'marketplace', ['Slot'])

        # Adding model 'Calendar'
        db.create_table(u'marketplace_calendar', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='calendar_teacher', to=orm['marketplace.User'])),
        ))
        db.send_create_signal(u'marketplace', ['Calendar'])

        # Adding M2M table for field slot on 'Calendar'
        m2m_table_name = db.shorten_name(u'marketplace_calendar_slot')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calendar', models.ForeignKey(orm[u'marketplace.calendar'], null=False)),
            ('slot', models.ForeignKey(orm[u'marketplace.slot'], null=False))
        ))
        db.create_unique(m2m_table_name, ['calendar_id', 'slot_id'])


    def backwards(self, orm):
        # Deleting model 'Slot'
        db.delete_table(u'marketplace_slot')

        # Deleting model 'Calendar'
        db.delete_table(u'marketplace_calendar')

        # Removing M2M table for field slot on 'Calendar'
        db.delete_table(db.shorten_name(u'marketplace_calendar_slot'))
