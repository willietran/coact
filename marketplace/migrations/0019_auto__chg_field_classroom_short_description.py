...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.short_description'
        db.alter_column(u'marketplace_classroom', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=160))

    def backwards(self, orm):

        # Changing field 'Classroom.short_description'
        db.alter_column(u'marketplace_classroom', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=500))
