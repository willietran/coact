...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Review'
        db.create_table(u'marketplace_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('classroom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='classroom_review', to=orm['marketplace.Classroom'])),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewer_review', to=orm['marketplace.Classroom'])),
        ))
        db.send_create_signal(u'marketplace', ['Review'])


    def backwards(self, orm):
        # Deleting model 'Review'
        db.delete_table(u'marketplace_review')
    ...
    models = {
        ...
        u'marketplace.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviewer_review'", 'to': u"orm['marketplace.Classroom']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '140'})
        },
